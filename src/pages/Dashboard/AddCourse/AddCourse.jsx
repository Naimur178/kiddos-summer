    ...
    const onSubmit = data => {
        ...
        .then(imgResponse => {
            if(imgResponse.success){
                ...
                const {courseTitle, price, outline, category, description} = data;
                ...
                const newItem = {instructorName, courseTitle, price: parseFloat(price), category, courseImage, curriculum, status, email, description }
                console.log(newItem)
